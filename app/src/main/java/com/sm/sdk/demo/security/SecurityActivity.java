...
public class SecurityActivity extends BaseAppCompatActivity {
    ...
    private void initView() {
        ...
        view = findViewById(R.id.save_cipher_text_key_under_rsa);
        leftText = view.findViewById(R.id.left_text);
        view.setOnClickListener(this);
        leftText.setText(R.string.security_save_ciphertext_key_under_rsa);

        view = findViewById(R.id.inject_cipher_text_key_under_rsa);
        leftText = view.findViewById(R.id.left_text);
        view.setOnClickListener(this);
        leftText.setText(R.string.security_inject_ciphertext_key_under_rsa);

        view = findViewById(R.id.inject_sym_key);
        leftText = view.findViewById(R.id.left_text);
        view.setOnClickListener(this);
        leftText.setText(R.string.security_inejct_symmetric_key);

        view = findViewById(R.id.tr34_test);
        leftText = view.findViewById(R.id.left_text);
        view.setOnClickListener(this);
        leftText.setText(R.string.security_tr34_test);

        view = findViewById(R.id.ecc_test);
        leftText = view.findViewById(R.id.left_text);
        view.setOnClickListener(this);
        leftText.setText(R.string.security_ecc_test);

        view = findViewById(R.id.ecc_recover);
        leftText = view.findViewById(R.id.left_text);
        view.setOnClickListener(this);
        leftText.setText(R.string.security_ecc_recover);

        view = findViewById(R.id.security_nlk_test);
        leftText = view.findViewById(R.id.left_text);
        view.setOnClickListener(this);
        leftText.setText(R.string.security_nlk_test);
    }
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.apacs_mac_test:
                ...
                break;
            case R.id.save_cipher_text_key_under_rsa:
                openActivity(SaveKeyCipherTextUnderRsaActivity.class);
                break;
            case R.id.inject_cipher_text_key_under_rsa:
                openActivity(InjectCiphertextKeyUnderRsaActivity.class);
                break;
            case R.id.inject_sym_key:
            ...
            case R.id.tr34_test:
                ...
                break;
            case R.id.ecc_test:
                openActivity(EccTestActivity.class);
                break;
            case R.id.ecc_recover:
                openActivity(EccRecoverActivity.class);
                break;
            case R.id.security_nlk_test:
                openActivity(NlkTestActivity.class);
                break;
        }
    }
