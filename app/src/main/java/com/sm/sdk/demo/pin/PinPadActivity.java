...
public class PinPadActivity extends BaseAppCompatActivity {
    ...
    private void initView() {
        ...
        chkModeList.put(R.id.chk_mode_min_input_warn, findViewById(R.id.chk_mode_min_input_warn));
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.chk_mode_min_input_warn:
    ...
    private void onSetPinPadModeClick() {
        try {
            ...
            if (chkModeList.get(R.id.chk_mode_min_input_warn).isChecked()) {
                bundle.putInt("minInputWarn", 1);
            }
