...
public class CtrCodeAndMultiApduActivity extends BaseAppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_card_active_and_data_ex_ctrcode_test_layout);
        initView();
        initData();
    }
...
//                    testTransmitApduWithCtrCode();
    ...
    private void transmitMultiApdusWithCtrCode() {
        try {
            ...
            int code = MyApplication.app.readCardOptV2.transmitMultiApdus(cardType, ctrCode, sendList, recvList);
    ...
    private void setText(CharSequence msg) {
        runOnUiThreadEx(() -> result.setText(msg));
    }
