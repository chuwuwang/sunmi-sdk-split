...
public class ICProcessActivity extends BaseAppCompatActivity {
    ...
    private void initEmvTlvData() {
        try {
            ...
            mEMVOptV2.setTlvList(TLVOpCode.OP_CPACE, tagsCPACE, valuesCPACE);
...
//            importCardNoStatus(0);
        ...
        public void onConfirmationCodeVerified() throws RemoteException {
            ...
            runOnUiThreadEx(() -> new AlertDialog.Builder(ICProcessActivity.this)
                    .setTitle("See Phone")
    ...
    private String getCardNo() {
        ...
        try {
            ...
            if (len <= 0) {
                LogUtil.e(TAG, "getCardNo error,code:" + len);
                return "";
            }
    ...
    public static CardInfo parseTrack2(String track2) {
        ...
        LogUtil.e(TAG, "cardNumber:" + cardNumber + " expireDate:" + expiryDate + " serviceCode:" + serviceCode);
