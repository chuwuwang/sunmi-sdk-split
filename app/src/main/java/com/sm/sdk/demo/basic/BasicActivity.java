...
public class BasicActivity extends BaseAppCompatActivity {
    ...
    private void initView() {
        ...
        item = findViewById(R.id.watermark_test);
        leftText = item.findViewById(R.id.left_text);
        leftText.setText(R.string.basic_watermark_test);
        item.setOnClickListener(this);

        item = findViewById(R.id.cit_test);
        leftText = item.findViewById(R.id.left_text);
        leftText.setText(R.string.basic_cit_test);
        item.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.log_control:
                ...
                break;
            case R.id.watermark_test:
                openActivity(CardWaterMarkActivity.class);
                break;
            case R.id.cit_test:
                openActivity(CitTestActivity.class);
                break;
