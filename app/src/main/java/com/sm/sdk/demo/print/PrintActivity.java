...
public class PrintActivity extends BaseAppCompatActivity {
    ...
    private void initView() {
        ...
        item = this.findViewById(R.id.print_dot_speed_level);
        leftText = item.findViewById(R.id.left_text);
        leftText.setText(R.string.print_dot_speed_level);
        item.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.print_config:
                ...
                break;
            case R.id.print_dot_speed_level:
                openActivity(PrintDotSpeedLevelActivity.class);
                break;
        }
    }
}
