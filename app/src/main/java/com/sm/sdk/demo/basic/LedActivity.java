...
public class LedActivity extends BaseAppCompatActivity {
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.mb_red_close:
                ...
                break;
            case R.id.mb_white_open:
                ledStatus(AidlConstants.LedLight.WHITE_LIGHT, 0);
                break;
            case R.id.mb_white_close:
                ledStatus(AidlConstants.LedLight.WHITE_LIGHT, 1);
                break;
    ...
    private void ledStatus(int ledIndex, int ledStatus) {
        try {
            ...
            int result = MyApplication.app.basicOptV2.ledStatusOnDevice(ledIndex, ledStatus);
    ...
    private void ledStatusEx(int redStatus, int greedStatus, int yellowStatus, int blueStatus) {
        try {
            ...
            int result = MyApplication.app.basicOptV2.ledStatusOnDeviceEx(redStatus, greedStatus, yellowStatus, blueStatus);
