...
public class FixPasswordKeyboard extends LinearLayout {
    ...
    private View cancel_0, cancel_1;
    private View enter_0, enter_1;
    ...
    private void initView(Context context) {
        ...
        cancel_0 = findViewById(R.id.cancel_0);
        cancel_1 = findViewById(R.id.cancel_1);
        enter_0 = findViewById(R.id.enter_0);
    ...
    public View getCancel_0() {
        return cancel_0;
    }

    public View getCancel_1() {
        return cancel_1;
    }

    public View getEnter_0() {
        return enter_0;
    }

    public View getEnter_1() {
        return enter_1;
    }
