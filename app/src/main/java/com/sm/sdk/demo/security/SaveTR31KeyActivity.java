...
public class SaveTR31KeyActivity extends BaseAppCompatActivity {
    ...
    private void testSavedDukptKey() {
        try {
            ...
            int keyIndex = Integer.parseInt(edtTR31KeyIndex.getText().toString());
            addStartTimeWithClear("dataEncryptDukpt()");
            int result = MyApplication.app.securityOptV2.dataEncryptDukpt(keyIndex, dataIn, encryptType, null, dataOut);
