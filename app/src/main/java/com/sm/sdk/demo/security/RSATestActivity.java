...
public class RSATestActivity extends BaseAppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_security_rsa_test);
        initView();
    }
...
//        edtPvtKeyExp.setText("");
    ...
    private void generateRsaKeyPair() {
        try {
            ...
            addStartTimeWithClear("generateRSAKeypair()");
            int len = MyApplication.app.securityOptV2.generateRSAKeypair(pvtKeyIndex, pvtKeySize, rsaKeyExpStr, dataOut);
            addEndTime("generateRSAKeypair()");
    ...
    private void injectRsaPublicKey() {
        try {
            ...
            addStartTimeWithClear("injectRSAKey()");
            int code = MyApplication.app.securityOptV2.injectRSAKey(keyIndex, keySize, keyModuleStr, keyPubExpStr);
            addEndTime("injectRSAKey()");
            ...
            if (code == 0) {//success
                ...
                showToast("inject RSA public key success");
            } else {//failed
                showToast("inject RSA public key failed,code:" + code);
            }
            showSpendTime();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void injectRsaPrivateKey() {
        try {
            ...
            int keySize = Integer.parseInt(keySizeStr);
            addStartTimeWithClear("injectRSAKey()");
            int code = MyApplication.app.securityOptV2.injectRSAKey(keyIndex, keySize, keyModuleStr, keyPvtExpStr);
            addEndTime("injectRSAKey()");
            LogUtil.e(TAG, "code:" + code);
            if (code == 0) {//success
                ...
                showToast("inject RSA private key success");
            } else {//failed
                showToast("inject RSA private key failed,code:" + code);
            }
            showSpendTime();
        } catch (Exception e) {
            e.printStackTrace();
