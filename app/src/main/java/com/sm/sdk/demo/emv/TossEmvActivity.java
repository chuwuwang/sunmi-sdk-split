...
import com.sm.sdk.demo.wrapper.EMVListenerV2Wrapper;
...
//            }
    ...
    private final EMVListenerV2 mEMVListener = new EMVListenerV2.Stub() {
        ...
        public void onConfirmCardNo(String cardNo) throws RemoteException {
            ...
            mCardNo = cardNo;
            runOnUiThreadEx(() -> mTvShowInfo.setText(mCardNo));
        ...
        public void onCertVerify(int certType, String certInfo) throws RemoteException {
            ...
            runOnUiThreadEx(() -> mTvShowInfo.setText(certInfo));
            importCertStatus(0);
        }
...
//                tryAgain();
        ...
        public void onConfirmationCodeVerified() throws RemoteException {
            ...
            runOnUiThreadEx(() -> new AlertDialog.Builder(TossEmvActivity.this)
                    .setTitle("See Phone")
