...
public class CardActivity extends BaseAppCompatActivity {
    ...
    private void initView() {
        ...
        view = findViewById(R.id.card_mifare_desfire_ev1);
        leftText = view.findViewById(R.id.left_text);
        view.setOnClickListener(this);
        leftText.setText(R.string.card_test_mifare_desfire_ev1);
        ...
        view = findViewById(R.id.card_get_nfc_param);
        leftText = view.findViewById(R.id.left_text);
        view.setOnClickListener(this);
        leftText.setText(R.string.card_get_nfc_param);

        view = findViewById(R.id.card_set_nfc_param);
        leftText = view.findViewById(R.id.left_text);
        view.setOnClickListener(this);
        leftText.setText(R.string.card_set_nfc_param);
    }
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.card_mifare_ultralight_ev1:
                ...
                break;
            case R.id.card_mifare_desfire_ev1:
                openActivity(MifareDesfireEv1Activity.class);
                break;
            ...
            case R.id.card_innovatron_test:
                ...
                break;
            case R.id.card_get_nfc_param:
                openActivity(GetNfcParamActivity.class);
                break;
            case R.id.card_set_nfc_param:
                openActivity(SetNfcParamActivity.class);
                break;
        }
    }
