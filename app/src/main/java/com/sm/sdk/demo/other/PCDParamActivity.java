...
public class PCDParamActivity extends BaseAppCompatActivity {
    ...
    private void readPCDParam() {
        try {
            ...
            String paramA = MyApplication.app.basicOptV2.getSysParam(AidlConstants.SysParam.PCD_PARAM_A);
            String paramB = MyApplication.app.basicOptV2.getSysParam(AidlConstants.SysParam.PCD_PARAM_B);
            String paramC = MyApplication.app.basicOptV2.getSysParam(AidlConstants.SysParam.PCD_PARAM_C);
    ...
    private void setPCDParam(String key, EditText edtValue) {
        try {
            ...
            addStartTimeWithClear("setSysParam(),key=" + key);
            int code = MyApplication.app.basicOptV2.setSysParam(key, value);
            addEndTime("setSysParam(),key=" + key);
            if (code < 0) {
