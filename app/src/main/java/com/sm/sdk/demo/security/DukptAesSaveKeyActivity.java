...
public class DukptAesSaveKeyActivity extends BaseAppCompatActivity {
    ...
    private void saveDukptAesKey() {
        try {
            ...
            int result = MyApplication.app.securityOptV2.saveKeyDukptAES(mDukptKeyType, mKeyType, keyValue, checkValue, ksnBytes, mKeyAlgType, keyIndex);
    ...
    private String getCheckValue(String key) {
        ...
        byte[] value = DesAesUtil.aesEncrypt(keyData, null, data, DesAesUtil.DATA_MODE_ECB);
