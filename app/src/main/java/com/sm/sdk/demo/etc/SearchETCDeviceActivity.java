...
public class SearchETCDeviceActivity extends BaseAppCompatActivity {
    ...
    private void updateResultText(CharSequence value) {
        runOnUiThreadEx(() -> result.setText(value));
    }
    ...
    private void setSearchParam() {
        try {
            ...
            int code = MyApplication.app.etcOptV2.setSearchParam(bundle);
    ...
    private void searchETCDevice() {
        try {
            ...
            MyApplication.app.etcOptV2.search(maxSearchNum, new ETCSearchListenerV2.Stub() {
                @Override
