...
public class VisualImpairmentPinActivity extends BaseAppCompatActivity {
    ...
    private void setVisualImpairmentParam() {
        int rnibSelectMode = 0;//0-double tap confirm, 1-long press confirm, 2-stay and double click to confirm
        int rnibHoldTime = 30; //press holding time in long press confirm mode
        int stayTime = 10; // the duration of finger hold in stay and double click to confirm mode, range:5~100, unit:100ms, default: 10
        try {
            Bundle bundle = new Bundle();
            ...
            bundle.putInt("rnibSelectMode", rnibSelectMode);//PIN number confirm mode, 0-double tap to confirm(default), 1-long press to confirm, 2-stay and double click to confirm
            ...
            bundle.putInt("beepOnConfirm", 1);//whether to play beep sound when double tap confirm or long press confirm, 0-not pay sound, 1- pay sound(default value)
            bundle.putInt("stayTime", stayTime); // the duration of finger holding in stay and double click to confirm mode, range:5~100, unit:100ms, default: 10
    ...
    private void updateInfo(String msg) {
        runOnUiThreadEx(() -> tvInfo.setText(msg));
    }
