...
/** After enabled SERD , use this page to test EMV transaction process. */
public class ICProcessActivityForSred extends BaseAppCompatActivity {
    ...
    private final Handler mHandler = new Handler(Looper.getMainLooper(), msg -> {
        switch (msg.what) {
            ...
            case EMV_APP_SELECT:
                ...
                mAppSelectDialog = new AlertDialog.Builder(ICProcessActivityForSred.this)
                        ...
                        .setSingleChoiceItems(candiNames, 0, (dialog, which) -> {
                            mSelectIndex = which;
                            LogUtil.e(TAG, "singleChoiceItems which:" + which);
                        }).create();
                mSelectIndex = 0;
            ...
            case PIN_CLICK_CANCEL:
                ...
                break;
            case PIN_ERROR:
                showToast("error->code:" + msg.arg1 + ", message:" + msg.obj);
            ...
            case EMV_TRANS_SUCCESS:
                resetUI();
                checkAndRemoveCard();
                showToast("success->code:" + msg.arg1 + ", message:" + msg.obj);
                break;
            case REMOVE_CARD:
                checkAndRemoveCard();
                break;
    ...
    private void initView() {
        ...
        toolbar.setTitle(R.string.emv_ic_process_sred);
        ...
        mBtnOperate.setOnClickListener((v) -> onButtonClick());
    }
     ...
     */
    private void setAccountSecDataParam() {
        try {
            final int TDK_INDEX = 14;
            //1.set account sec data with mksk
            Bundle pIn = new Bundle();
            pIn.putInt("encKeySystem", Security.SEC_MKSK);
            pIn.putInt("encKeyIndex", TDK_INDEX);
            pIn.putInt("encKeyAlgType", Security.KEY_ALG_TYPE_3DES);
            pIn.putInt("encMode", Security.DATA_MODE_CBC);
            pIn.putByteArray("encIv", new byte[16]);
            pIn.putByte("encPaddingMode", (byte) 0);
            pIn.putInt("encMaskStart", 6);
            pIn.putInt("encMaskEnd", 4);
            pIn.putChar("encMaskWord", '*');
            // pIn.putString("panAppendContent", "01696069");
            // pIn.putInt("panAppendMode", 0);
            int code = MyApplication.app.emvOptV2.setAccountDataSecParam(pIn);
    ...
    private void initEmvTlvData() {
        try {
            ...
            MyApplication.app.emvOptV2.setTlvList(TLVOpCode.OP_PAYPASS, tagsPayPass, valuesPayPass);
            ...
            MyApplication.app.emvOptV2.setTlvList(TLVOpCode.OP_AE, tagsAE, valuesAE);

            // set JC tlv data
            String[] tagsJCB = {"9F53", "DF8161"};
            String[] valuesJCB = {"708000", "7F00"};
            MyApplication.app.emvOptV2.setTlvList(TLVOpCode.OP_JCB, tagsJCB, valuesJCB);

            // set CPACE (Zimswitch) tlv data
            final String limit_CDCVM_DF8516 = "999999999999";
            final String limit_without_CDCVM_DF8515 = "999999999999";
            final String CVM_cap_above_DF8513 = "68";
            final String CVM_cap_below_DF8514 = "08";
            final String Kernel_Config_DF811B = "30";
            final String CVM_required_limit_DF8512 = "000000005000"; // 或者AID中CVM limit 设置
            final String time_RR_comm_DF8507 = "0012";
            final String time_RR_resp_DF8506 = "0018";
            final String min_time_RR_tolerance_DF8508 = "0014";
            final String max_time_RR_tolerance_DF8509 = "0032";
            final String min_time_RR_dif_DF8511 = "012C";
            final String tran_time_RR_mismatch_DF8510 = "32";
            String[] tagsCPACE = {"DF8516", "DF8515", "DF8513", "DF8514", "DF8512", "DF8507", "DF811B", "DF8506", "DF8508", "DF8509", "DF8511", "DF8510"};
            String[] valuesCPACE = {limit_CDCVM_DF8516, limit_without_CDCVM_DF8515, CVM_cap_above_DF8513, CVM_cap_below_DF8514,
                    CVM_required_limit_DF8512, time_RR_comm_DF8507, Kernel_Config_DF811B, time_RR_resp_DF8506,
                    min_time_RR_tolerance_DF8508, max_time_RR_tolerance_DF8509, min_time_RR_dif_DF8511, tran_time_RR_mismatch_DF8510};
            MyApplication.app.emvOptV2.setTlvList(TLVOpCode.OP_CPACE, tagsCPACE, valuesCPACE);
    ...
    private void checkCard() {
        try {
            ...
            // Use the TDK which saved at index=12
            final int TDK_INDEX = 12;
            Bundle bundle = new Bundle();
            bundle.putInt("cardType", cardType);
            bundle.putInt("track2Priority", 1);
            ...
            bundle.putInt("encMode", Security.DATA_MODE_CBC);
    ...
    private final CheckCardCallbackV2 mCheckCardCallback = new CheckCardCallbackV2Wrapper() {
        ...
        public void findMagCard(Bundle bundle) throws RemoteException {
            ...
            LogUtil.e(TAG, "findMagCard:" + bundle);
        }
        ...
        public void findICCard(String atr) throws RemoteException {
            ...
            mCardType = AidlConstants.CardType.IC.getValue();
            transactProcess();
        }
    ...
    private final EMVListenerV2 mEMVListener = new EMVListenerV2.Stub() {
        ...
        public void onAppFinalSelect(String tag9F06Value) throws RemoteException {
            ...
            if (!TextUtils.isEmpty(tag9F06Value)) {
                ...
                LogUtil.e(TAG, "detect " + paymentType + " card");
            }
...
//            importCardNoStatus(0);
        ...
        public void onRequestShowPinPad(int pinType, int remainTime) throws RemoteException {
            ...
            LogUtil.e(TAG, "onRequestShowPinPad pinType:" + pinType + " remainTime:" + remainTime);
            mPinType = pinType;
            if (mCardNo == null) {
                mCardNo = getCardNo();
            }
        ...
        public void onConfirmationCodeVerified() throws RemoteException {
            ...
            int len = MyApplication.app.emvOptV2.getTlv(TLVOpCode.OP_PAYPASS, "DF8129", buffer);
            if (len > 0) {
                String hexStr = ByteUtil.bytes2HexStr(Arrays.copyOf(buffer, len));
                LogUtil.e(TAG, "DF8129: " + hexStr);
            }
            // card off
            MyApplication.app.readCardOptV2.cardOff(mCardType);
            runOnUiThreadEx(() -> new AlertDialog.Builder(ICProcessActivityForSred.this)
                    .setTitle("See Phone")
        ...
        public void onRequestDataExchange(String cardNo) throws RemoteException {
            ...
            LogUtil.e(TAG, "onRequestDataExchange,cardNo:" + cardNo);
    ...
    private String getCardNo() {
        try {
            LogUtil.e(TAG, "getCardNo()");
            final String[] tagList = {"57", "5A"};
            Map<String, String> map = getAccountSensitiveTlvData(TLVOpCode.OP_NORMAL, tagList);
            return map.get("panMask");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "";
    ...
    private void importAppSelect(int selectIndex) {
        LogUtil.e(TAG, "importAppSelect selectIndex:" + selectIndex);
        try {
    ...
    private void importFinalAppSelectStatus(int status) {
        try {
            LogUtil.e(TAG, "importFinalAppSelectStatus status:" + status);
    ...
    private void importCardNoStatus(int status) {
        LogUtil.e(TAG, "importCardNoStatus status:" + status);
        try {
    ...
    private void importCertStatus(int status) {
        LogUtil.e(TAG, "importCertStatus status:" + status);
        try {
    ...
    private void importPinInputStatus(int inputResult) {
        LogUtil.e(TAG, "importPinInputStatus:" + inputResult);
        try {
    ...
    private void importSignatureStatus(int status) {
        LogUtil.e(TAG, "importSignatureStatus status:" + status);
        try {
    ...
    private void importOnlineProcessStatus(int status) {
        LogUtil.e(TAG, "importOnlineProcessStatus status:" + status);
        try {
            ...
            if (len < 0) {
                ...
                LogUtil.e(TAG, "importOnlineProcessStatus outData:" + hexStr);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void getTlvData() {
        try {
            final String[] normalTags = {
                    "DF02", "5F34", "9F06", "FF30", "FF31", "95", "9B", "9F36", "9F26",
                    "9F27", "DF31", "5F24", "9F1A", "9F33", "9F35", "9F40",
            ...
            Map<String, String> tlvMap1 = getNormalTlvList(tlvOpCode, normalTags);
            map.putAll(tlvMap1);

            // payPassTags
            final String[] payPassNormalTags = {
                    "DF811E", "DF812C", "DF8118", "DF8119", "DF811F", "DF8117", "DF8124",
                    "DF8125", "9F6D", "DF811B", "9F53", "DF810C", "9F1D", "DF8130", "DF812D",
                    "DF811C", "DF811D", "9F7C",
            };
            Map<String, String> tlvMap2 = getNormalTlvList(TLVOpCode.OP_PAYPASS, payPassNormalTags);
            map.putAll(tlvMap2);

            final String[] sensitiveTags = {
                    "57", "56", "5A", "5F21", "5F22", "5F23", "9F6B", "9F1F", "9F20",
                    "DFDB01", "DFDB02", "DFDB03", "DFDB04", "DFDB05",
            };
            Map<String, String> tlvMap3 = getAccountSensitiveTlvData(tlvOpCode, sensitiveTags);
            map.putAll(tlvMap3);
            ...
            runOnUiThreadEx(() -> mTvShowInfo.setText(sb));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    /** Get normal tlv data */
    private Map<String, String> getNormalTlvList(int opCode, String[] tags) {
        Map<String, String> result = new LinkedHashMap<>();
        try {
            byte[] buffer = new byte[2048];
            int len = MyApplication.app.emvOptV2.getTlvList(opCode, tags, buffer);
            if (len > 0) {
                ...
                for (String key : map.keySet()) {
                    TLV tlv = map.get(key);
                    result.put(key, tlv == null ? "" : tlv.getValue());
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    /** Get account sensitive tlv data */
    private Map<String, String> getAccountSensitiveTlvData(int opCode, String[] tags) {
        Map<String, String> result = new LinkedHashMap<>();
        try {
            Bundle bundle = new Bundle();
            int code = MyApplication.app.emvOptV2.getAccountSecData(opCode, tags, bundle);
            if (code < 0) {
                return result;
            }
    ...
    private String[] getCandidateNames(List<EMVCandidateV2> candiList) {
        ...
        for (int i = 0; i < candiList.size(); i++) {
            ...
            result[i] = name;
            LogUtil.e(TAG, "EMVCandidateV2: " + name);
        }
        return result;
    }
    ...
    private void tryAgain() {
        runOnUiThreadEx(() -> new AlertDialog.Builder(this)
                .setTitle("Try again")
    ...
    private void checkAndRemoveCard() {
        try {
            ...
            int status = MyApplication.app.readCardOptV2.getCardExistStatus(mCardType);
            addEndTime("getCardExistStatus()");
            showSpendTime();
            if (status < 0) {
                LogUtil.e(TAG, "getCardExistStatus error, code:" + status);
                dismissLoadingDialog();
                return;
            }
