...
public final class KeyIndexUtil {
    ...
    public static boolean checkEccKeyIndex(int keyIndex) {
        return keyIndex >= 0 && keyIndex <= 9;
    }

    public static boolean checkNlkMkskKeyIndex(int keyIndex) {
        return keyIndex >= 0 && keyIndex <= 99;
    }

    public static boolean checkNlkRsaKeyIndex(int keyIndex) {
        return keyIndex >= 0 && keyIndex <= 19;
    }

    public static boolean checkNlkEccKeyIndex(int keyIndex) {
        return keyIndex >= 0 && keyIndex <= 19;
    }

    public static boolean checkNlkCertKeyIndex(int keyIndex) {
        return keyIndex >= 0 && keyIndex <= 9;
    }

    public static boolean checkNlkSm2KeyIndex(int keyIndex) {
        return keyIndex >= 0 && keyIndex <= 19;
    }
}
