...
public class ETCTradeActivity extends BaseAppCompatActivity {
    ...
    private void initView() {
        ...
        button = findViewById(R.id.mb_ok);
    ...
    private void etcTrade() {
        try {
            ...
            EditText obuId = findViewById(R.id.obuId);
            if (!checkInputData(obuId)) {
                return;
            }
            result.setText(null);
            //模拟交易(复合消费回复正确数据)
            ...
            //OBUId(Hex，4B)，可传null
            String hexObuId = obuId.getText().toString();
...
//            task.block();
    ...
    private void addText(CharSequence msg) {
        ...
        runOnUiThreadEx(() -> result.setText(TextUtils.concat(preMsg, "\n", msg + "\n")));
    }
    ...
    private void updateButtonStatus(boolean enable) {
        runOnUiThreadEx(() -> button.setEnabled(enable));
    }
    ...
    private static class HeartBeatTask implements Runnable {
        ...
        public synchronized void run() {
            try {
                Thread.interrupted();
                LogUtil.e(TAG, "start heartbeat task");
                ...
                while (!Thread.interrupted()) {
                    ...
                    while (isStart) {
                        LogUtil.e(TAG, "send heartbeat packet");
                ...
                isStart = false;
                thread = null;
                LogUtil.e(TAG, "quit heartbeat task");
            }
        }
