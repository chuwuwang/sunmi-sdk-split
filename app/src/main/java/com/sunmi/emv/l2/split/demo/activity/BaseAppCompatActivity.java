...
import com.sunmi.emv.l2.split.demo.view.LoadingDialog;
import com.sunmi.emv.l2.split.demo.view.SwingCardHintDialog;
import com.sunmi.emv.l2.utils.LogUtil;
...
public abstract class BaseAppCompatActivity extends AppCompatActivity implements View.OnClickListener {
    public static final String TAG = "EmvL2SplitDemo";
