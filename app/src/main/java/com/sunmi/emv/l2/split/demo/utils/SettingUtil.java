package com.sunmi.emv.l2.split.demo.utils;
...
public final class SettingUtil {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(jsonStr)) {
                ...
                if (jobj.has(KEY_PSAM_CHANNEL)) {
                    ...
                    Log.e(TAG, "has psam channel:" + channel);
                    return channel;
                }
            }
        } catch (Exception e) {
            Log.e(TAG, "SettingUtil getPSAMChannel:" + e);
            e.printStackTrace();
        }
        return channel;
    }
    ...
    public static void switchPSAMChannel() {
        try {
            ...
            Log.e(TAG, "switch psam channel to " + curChannel + " success");
        } catch (Exception e) {
            Log.e(TAG, "SettingUtil getSupportKeyPartition:" + e);
            e.printStackTrace();
        }
    }
    ...
    public static boolean getAutoRestoreNfc() {
        ...
        try {
            ...
            Log.e(TAG, "autoRestoreNfc:" + autoRestoreNfc);
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//            if (code < 0) {
//                Log.e(TAG, "setPinPadMode failed,code:" + code);
//            }
...
//        return code;
    ...
    public static boolean getIsolateM1AndCPU() {
        try {
            ...
            Log.e(TAG, "isolateM1AndCPU:" + value);
            return value;
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static int getCardPollIntervalTime() {
        ...
        try {
            ...
            Log.e(TAG, "cardPollIntervalTime:" + value);
            return value;
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void setMagCardRoundPollTimes(int times) {
        try {
            JSONObject jobj = new JSONObject();
            String jsonStr = MyApplication.app.basicOptV2.getSysParam(AidlConstants.SysParam.RESERVED);
            if (!TextUtils.isEmpty(jsonStr)) {
                jobj = new JSONObject(jsonStr);
            }
            jobj.put(KEY_MAG_CARD_ROUND_POLL_TIMES, times);
            MyApplication.app.basicOptV2.setSysParam(AidlConstants.SysParam.RESERVED, jobj.toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static int getMagCardRoundPollTimes() {
        ...
        try {
            ...
            Log.e(TAG, "magCardRoundPollTimes:" + value);
            return value;
        } catch (Exception e) {
            e.printStackTrace();
        }
